...
Tenho experiência com **automação de processos utilizando n8n**, voltada para otimização e produtividade. 

Também possuo conhecimentos no **desenvolvimento de aplicações utilizando, JavaScript e Node.js**, integração com APIs externas e manipulação de dados.
